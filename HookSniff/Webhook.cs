...
namespace HookSniff
{
    public sealed class Webhook
    {
        ...
        internal const string HOOKSNIFF_ID_HEADER_KEY = "hooksniff-id";
        internal const string HOOKSNIFF_SIGNATURE_HEADER_KEY = "hooksniff-signature";
        internal const string HOOKSNIFF_TIMESTAMP_HEADER_KEY = "hooksniff-timestamp";
        ...
        public void Verify(ReadOnlySpan<char> payload, Func<string?, string?> headersProvider)
        {
            ...
            ReadOnlySpan<char> msgId = headersProvider(HOOKSNIFF_ID_HEADER_KEY);
            ReadOnlySpan<char> msgTimestamp = headersProvider(HOOKSNIFF_TIMESTAMP_HEADER_KEY);
            ReadOnlySpan<char> msgSignature = headersProvider(HOOKSNIFF_SIGNATURE_HEADER_KEY);
