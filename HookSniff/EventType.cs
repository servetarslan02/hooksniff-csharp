...
namespace HookSniff
{
    public class EventTypeListOptions : HookSniffOptionsBase
    {
    ...
    public class EventTypeCreateOptions : HookSniffOptionsBase
    {
    ...
    public class EventTypeImportOpenapiOptions : HookSniffOptionsBase
    {
        public string? IdempotencyKey { get; set; }
    ...
    public class EventTypeDeleteOptions : HookSniffOptionsBase
    {
    ...
    public class EventType(HookSniffClient client)
    {
